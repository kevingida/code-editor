...
declare type UnresolvedKeyframes<T extends string | number> = Array<T | null>;
declare type ResolvedKeyframes<T extends string | number> = Array<T>;
declare type OnKeyframesResolved<T extends string | number> = (resolvedKeyframes: ResolvedKeyframes<T>, finalKeyframe: T) => void;
...
declare type ResolveKeyframes<V extends string | number> = (keyframes: V[], onComplete: OnKeyframesResolved<V>, name?: string, motionValue?: any) => KeyframeResolver<V>;
...
declare type Mixer<T> = (p: number) => T;
...
declare type ComplexValues = Array<CSSVariableToken | string | number | Color>;
